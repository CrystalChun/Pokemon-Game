...
public class Pikachu extends Pokemon implements Electric
{
	...
	{
		System.out.println(super.getName() + " uses Thunder Shock! oooh shocker ~zing~");		
	...
	{
		System.out.println(super.getName() + "Thunder Shock! ZAPPERINO");
	...
	{
		System.out.println(super.getName() + " gathers electricity in its fist and uses Thunder PUNCH!! ZA POWWWW");
