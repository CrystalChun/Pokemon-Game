...
public class Zapdos extends Pokemon implements Electric
{
	...
	{
		System.out.println(super.getName() + " used thunder shock! Zing~ヽ( ･益･)ﾉﾟ･*:.｡. .｡.:*･゜ﾟ･*");
	...
	{
		System.out.println(super.getName() + " used thunder bolt! ϟ ZAPPERINI ϟ");
	...
	{
		System.out.println(super.getName() + " used thunder punch! ᕦ( ✿ ⊙ ͜ʖ ⊙ ✿ )⊃☆ﾟ.*･｡ﾟ");
